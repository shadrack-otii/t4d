...
<style>
    ...
    .clip-trapezoid {
        clip-path: polygon(0 0, 100% 0, 90% 100%, 0 70%);
    }
...
@section('content')
    <div class="">
        ...
        <div class="breadcrumbs mt16 pt-2 pb-3 pl-5 bg-[#1ea19d] h-10 text-white" id="tp">
            ...
            <span class="text-white">Our Packages</span>
        </div>
        ...
        <div>
            ...
            <!-- Cardz Overlap Section -->
            <div class="w-full lg:w-5/6 lg:mx56 container mx-auto mt-20 px-8 lg:px-20">
                <div class="bg-[#1ea19d] p-8 rounded-xl bg-cover  h-full lg:hscreen shadow-lg w11/12 max-w6xl">
                    
                    <div class="text-center">
                        <div>
                            <h1 class="text-center font-bold mb-6 text-2xl text-white">Do you want to register as an Individual or a Group?</h1>
                        </div>
                        <div class="grid grid-cols-1 lg:grid-cols-3">
                            <a href="#explore-individuals" class="link-taps mb8 active bg-[#a11e22] text-white font-bold py-2 px-6 rounded-full">
                                Explore Individual Packages
                            </a>
                            <a href="#explore-corporate" class="link-taps mb8 font-bold text-white py-2 px-6 rounded-full">
                                Explore Group Packages
                            </a>
                            <a href="#customize-corporate" class="link-taps font-bold text-white py-2 px-6 rounded-full">
            ...
            {{-- <div class="w-full lg:w-[1024px] mx-auto lg:my-10 px-20 relative">
                <span class="">
                    <h1 class="text-4xl font-bold text-center text-[#a11e22]">Explore Our Packages</h1>
                    <hr class="my-4 border border-[#a11e22]"/>
                </span>
            </div> --}}
            <div class="clearfix" id="explore-individuals"></div>
            ...
            <div class="clearfix" id="explore-corporate"></div>
            ...
            {{-- <div class="grid grid-cols-1 md:grid-cols-3 gap-8  p-6">
                <!-- Card with Broken Border -->
                <div>
                    <fieldset class="bg-white my-5 mb-2 lg:w-5/6 mx-auto px-5 pt-5 md:pt-5 pb-3 md:pb-14 border-2 border-[#CD7F32] relative">
                        <legend
                            class="p-4 px-2 md:px-3 lg:px-5 lg:text2xl font-bold md:ml-[100px] text-[#a11e22]">
                            <span class="mlauto text-3xl text-blue-400">
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-4">
                                <h3 class="text-xl font-bold text-[#CD7F32]">Silver <span class="text-gray-600">Package</span></h3>
                                
                            </div>
                            <p class="text-sm text-gray-500 mb-4">(All Standard Inclusive)</p>
                            <ul class="list-none text-left px-10 textwhite mb-4 space-y-2">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z"/><path fill="green" d="M19.495 3.133a1 1 0 0 1 1.352.309l.99 1.51a1 1 0 0 1-.155 1.279l-.003.004l-.014.013l-.057.053l-.225.215a84 84 0 0 0-3.62 3.736c-2.197 2.416-4.806 5.578-6.562 8.646c-.49.856-1.687 1.04-2.397.301l-6.485-6.738a1 1 0 0 1 .051-1.436l1.96-1.768A1 1 0 0 1 5.6 9.2l3.309 2.481c5.169-5.097 8.1-7.053 10.586-8.548m.21 2.216c-2.29 1.432-5.148 3.509-9.998 8.358A1 1 0 0 1 8.4 13.8l-3.342-2.506l-.581.524l5.317 5.526c1.846-3.07 4.387-6.126 6.49-8.438a86 86 0 0 1 3.425-3.552l-.003-.005Z"/></g></svg>
                                    Study Tours</li>
                                <li>
                            ...
                            <a href="#" class="block text-center ires-primary-btn text-white py-2 rounded-lg hover:bg-blue-600">
                                CREATE &raquo;
                            </a>
                        </div>
                    </fieldset>
                ...
                <div>
                    <fieldset class="bg-white my-5 mb-2 lg:w5/6 mx-auto px-5 pt-5 md:pt-5 pb-3 md:pb-14 border-2 border-[#D4af37] relative">
                        <legend
                            class="p-4 px-2 md:px-3 lg:px-5 lg:text2xl font-bold md:ml-[100px] text-[#a11e22]">
                            <span class=" bg-[#a11e22] text-[12px] px-2 py-3  my-3 rounded text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" class="inline" width="1em" height="1em" viewBox="0 0 20 20"><path fill="#1ea19d" d="M19.388.405a.605.605 0 0 0-1.141.399c.929 2.67-.915 4.664-2.321 5.732l-.568-.814c-.191-.273-.618-.5-.95-.504l-3.188.014a2.16 2.16 0 0 0-1.097.338L.729 12.157a1.01 1.01 0 0 0-.247 1.404l4.269 6.108c.32.455.831.4 1.287.082l9.394-6.588c.27-.191.582-.603.692-.918l.998-3.145c.11-.314.043-.793-.148-1.066l-.346-.496c1.888-1.447 3.848-4.004 2.76-7.133m-4.371 9.358a1.61 1.61 0 0 1-2.24-.396a1.614 1.614 0 0 1 .395-2.246a1.61 1.61 0 0 1 1.868.017c-.272.164-.459.26-.494.275a.606.606 0 0 0 .259 1.153q.13 0 .257-.059q.292-.137.619-.33a1.62 1.62 0 0 1-.664 1.586"/></svg>
                                Most sold
                            </span>
                        </legend>
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-4">
                                <h3 class="text-xl font-bold text-[#D4af37]">Gold <span class="text-gray-600">Package</span></h3>
                                
                            </div>
                            <p class="text-sm text-gray-500 mb-4">(All Silver Inclusive)</p>
                            <ul class="list-none text-left px-10 textwhite mb-4 space-y-2">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z"/><path fill="green" d="M19.495 3.133a1 1 0 0 1 1.352.309l.99 1.51a1 1 0 0 1-.155 1.279l-.003.004l-.014.013l-.057.053l-.225.215a84 84 0 0 0-3.62 3.736c-2.197 2.416-4.806 5.578-6.562 8.646c-.49.856-1.687 1.04-2.397.301l-6.485-6.738a1 1 0 0 1 .051-1.436l1.96-1.768A1 1 0 0 1 5.6 9.2l3.309 2.481c5.169-5.097 8.1-7.053 10.586-8.548m.21 2.216c-2.29 1.432-5.148 3.509-9.998 8.358A1 1 0 0 1 8.4 13.8l-3.342-2.506l-.581.524l5.317 5.526c1.846-3.07 4.387-6.126 6.49-8.438a86 86 0 0 1 3.425-3.552l-.003-.005Z"/></g></svg>
                                    Study Tours</li>
                ...
                <div class="">    
                    <fieldset class="bg-white my5 mb2 lg:w-5/6 mx-auto px-5 pt-5 md:pt-5 pb-3 md:pb-14 border-2 border-[#7300AB] relative">
                        <legend
                            class="p-4 px-2 md:px-3 lg:px-6 lg:text2xl font-bold md:ml-[100px] text-[#a11e22]">
                            <span class="mlauto text-3xl text-blue-400">
                                <i class="fas fa-server"></i>
                            </span>
                        </legend>
                        ...
                        <div class="relative z-10">
                            <div class="flex items-center mb-4">
                                <h3 class="text-xl font-bold text-[#D4af37]">Platinum <span class="text-gray-600">Package</span></h3>
                                
                            </div>
                            <p class="text-sm text-gray-500 mb-4">(All Gold Inclusive)</p>
                            <ul class="list-none text-left px-10 textwhite mb-4 space-y-2">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="inline" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="m12.594 23.258l-.012.002l-.071.035l-.02.004l-.014-.004l-.071-.036q-.016-.004-.024.006l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.016-.018m.264-.113l-.014.002l-.184.093l-.01.01l-.003.011l.018.43l.005.012l.008.008l.201.092q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.003-.011l.018-.43l-.003-.012l-.01-.01z"/><path fill="green" d="M19.495 3.133a1 1 0 0 1 1.352.309l.99 1.51a1 1 0 0 1-.155 1.279l-.003.004l-.014.013l-.057.053l-.225.215a84 84 0 0 0-3.62 3.736c-2.197 2.416-4.806 5.578-6.562 8.646c-.49.856-1.687 1.04-2.397.301l-6.485-6.738a1 1 0 0 1 .051-1.436l1.96-1.768A1 1 0 0 1 5.6 9.2l3.309 2.481c5.169-5.097 8.1-7.053 10.586-8.548m.21 2.216c-2.29 1.432-5.148 3.509-9.998 8.358A1 1 0 0 1 8.4 13.8l-3.342-2.506l-.581.524l5.317 5.526c1.846-3.07 4.387-6.126 6.49-8.438a86 86 0 0 1 3.425-3.552l-.003-.005Z"/></g></svg>
                                    Study Tours</li>
    ...
    @section('js_content')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const navLinks = document.querySelectorAll('.link-taps');
                const sections = document.querySelectorAll('section');

                function activateLink(link) {
                    navLinks.forEach((a) => {
                        a.classList.remove('active', 'bg-[#a11e22]', 'text-white');
                    });
                    link.classList.add('active', 'bg-[#a11e22]', 'text-white');
                }
                ...
                // Set "explore-individuals" as active by default on page load
                const defaultActiveLink = document.querySelector('.link-taps[href="#explore-individuals"]');
