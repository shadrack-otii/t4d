<!-- registration inputs --> 
<div>
    <form action="{{ route('contact.submit') }}" method="post" id="smes-contact">

        @csrf
        
        <input value="small to mid-sized business" type="hidden" name="type">
        ...
        <div class="reg-sec">
            <div class="form-row text-left">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" placeholder="Full Name" value="{{old('name')}}" name="name" required>
                </div>
                <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6">
              ...
              <input type="tel" class="form-control" placeholder="Phone" value="{{old('phone')}}" name="phone">
          </div>
          <div class="form-group col-md-6">
              <small class="form-text text-muted">Company Name</small>
              <input type="text" class="form-control" placeholder="Company" value="{{old('company')}}" name="company">
          </div>
          <div class="form-group col-md-6">
              <small class="form-text text-muted">Number of Employees</small>
              <input type="number" class="form-control" placeholder="No. of Employess" value="{{old('no_of_employees')}}" name="no_of_employees">
          </div>
          <div class="form-group col-md-6">
