                                        ...
                                        <table class="w-full bg-white table-auto border">
                                            <thead>
                                                <tr class="bg-gray-200">
                                                    ...
                                                    <th class="px-4 py-2 max-md:hidden">Duration</th>
                                                    <th class="px-1 md:px-4 py-2">Location</th>
                                            ...
                                            <tbody>
                                                @forelse ($month_schedule as $schedule)
                                                    ...
                                                    <tr class="border-b">
                                                        ...
                                                        <td class="px-4 py-2 border max-md:hidden">{{ $schedule->duration }} {{ ngettext('day', 'days', $schedule->duration) }}</td>
                                                        <td class="px-1 md:px-4 py-2 border">
                                                            @if ($schedule->type == 'virtual')
                                                                Virtual
                                                            @else
                                                                {{ "{$schedule->city->name}, {$schedule->city->venue->country}" }}
                                                            @endif
                                                        </td>
                                                        <td class="px-1 md:px-4 py-2 border">
