...
@section('title', "$bundle->name | Professional Certifications")
    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <span>
                    <a href="{{ route('course.certification.index') }}">
                ...
                <div class="container">
                    <div class="ip-content-one">
                        ...
                        <span class="ip-heading">
                            <h3>{{ $bundle->name }} Professional Certification.</h3>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="ip-content">
                <div class="container">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="face-to-face" role="tabpanel" aria-labelledby="nav-face-to-face-tab">
                                <table class="table table-sm table-responsive table-striped ires-table">
                                    ...
                                    <tbody>
                                        @foreach ($bundle->physicalBundles->load('currencies') as $schedule)
                                            <tr>
                                                <td>{{ $bundle->code }}</td>
                                                ...
                                                <td>
                                                    <a class="td-reg-btn" href="{{ route('course.certification.booking.create', [
                            ...
                            <div class="tab-pane fade" id="virtual" role="tabpanel" aria-labelledby="nav-virtual-tab">
                                <table class="table table-sm table-responsive table-striped ires-table">
                                    ...
                                    <tbody>
                                        @foreach ($bundle->virtualBundles->load('currencies') as $schedule)
                                            <tr>
                                                <td>{{ $bundle->code }}</td>
                                                <td>{{ date('j F Y', strtotime($schedule->from)) }} - {{ date('j F Y', strtotime($schedule->to)) }}</td>
                                                <td>
                            ...
                            <div class="tab-pane fade" id="elearning" role="tabpanel" aria-labelledby="nav-elearning-tab">
                                ...
                                @if ($bundle->elearningBundle)
                                    <a href="{{ strpos($bundle->elearningBundle->website, 'http') ? strreplace('http://', 'https://', $bundle->elearningBundle->website) : "https://{$bundle->elearningBundle->website}" }}" target="_blank">
                                        {{ $bundle->elearningBundle->website }}
                                    </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            <nav>
                                <div class="nav nav-tabs ip-cdesc-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-cadm-tab" data-toggle="tab" href="#nav-cadm" role="tab" aria-controls="nav-cadm" aria-selected="false">Course Administration Details</a>
                                    ...
                                    <a class="nav-item nav-link" id="nav-cout-tab" data-toggle="tab" href="#nav-cout" role="tab" aria-controls="nav-cout" aria-selected="false">Course Objectives</a>
                                    <a class="nav-item nav-link" id="nav-ctrn-tab" data-toggle="tab" href="#nav-ctrn" role="tab" aria-controls="nav-ctrn" aria-selected="false">Associated Courses</a>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-cadm" role="tabpanel" aria-labelledby="nav-cadm-tab">
                                        ...
                                        <tbody>
                                            @forelse ($bundle->courses as $course)
                                                <tr>
                                                    ...
                                                    <td>{{ $course->name }}</td>
                                                    <td>
                                                        <a class="td-reg-btn" href="{{ route('course.show', $course) }}" target="_blank">
                                                            View Details
                                                        </a>
                                                    </td>
                                                </tr>
                        ...
                        <div class="c-desc-share">
                            ...
                            <div class="modal fade" id="popDownload" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <form action="{{ route('course.certification.document') }}" method="POST" class="modal-content">
                            ...
                            <div class="c-desc-social">
                                ...
                                <a class="fb" href="http://www.facebook.com/sharer.php?u={{ route('course.certification.show', $bundle) }}" target="_blank" title="Share on Facebook"><i class="fa fa-facebook-official" aria-hidden="true"></i></a>
                                <a class="tw" href="https://twitter.com/share?url={{ route('course.certification.show', $bundle) }}" target="_blank" title="Share on Twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a class="in" href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('course.certification.show', $bundle) }}" target="_blank" title="Share on LinkedIn"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                <a class="wa" href="https://wa.me/?text={{ route('course.certification.show', $bundle) }}" target="_blank" title="Share on WhatsApp"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <!-- END (social) share -->
                    </div>
                    ...
                    @php
                        $other_bundles = App\CourseBundle::where('id', '<>', $bundle->id)->inRandomOrder()->take(4)->get();
                    @endphp
                                ...
                                @foreach ($other_bundles as $other_bundle)
                                    ...
                                    <div class="col-sm-3 ip-st-col">
                                        <div class="ip-cat-img-new">
                                            <img src="{{ asset('storage/'.$other_bundle->cover) }}">
                                            <div class="clearfix">
                                                <div class="float-left">
                                                    <h6>
                                                        <a href="{{ route('course.certification.show', $other_bundle) }}">
                                                            {{ $other_bundle->name }}
                                                        </a>
                                                    </h6>
                                                    <span class="bundle-course-no">
                                                        {{ $other_bundle->courses_count }}
                                                        {{ ngettext('course', 'courses', $other_bundle->courses_count) }}
                                                    </span>
                                                </div>
                                                <button class="btn btn-primary float-right" type="button" onclick="window.location.href = `{{ route('course.certification.show', $other_bundle) }}`">
                                                    View
                                                </button>
                                            </div>
                                        </div>
