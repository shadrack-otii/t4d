    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <!-- current page -->
                <span class="bc-current-page">Registered Courses</span>
            </div>
                ...
                <div class="container">
                    ...
                    <div>
                        ...
                        <div class="tab-pane fade show active" id="nav-courses" role="tabpanel" aria-labelledby="nav-courses-tab">
                            <p>This is a list of all the courses you have applied for.</p>
                                        ...
                                        @forelse ($bookings as $booking)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="td-ma-btn" href="{{ route('customer.account.course.show', $booking) }}">
                                                        View Details
                                                    </a>

                                                    &nbsp;

                                                    <a class="td-ma-btn" href="{{ route('customer.account.course.feedback', $booking) }}">
                                                        Leave a feedback
                                                    </a>
