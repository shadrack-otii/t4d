...
@section('title', "{$booking->certificationBundle->name} | Registered Courses")
    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <span>
                    <a href="{{ route('customer.account.certification_bundle.index') }}">
                ...
                <span class="bc-current-page">
                    {{ $booking->certificationBundle->name }}
                </span>
            </div>
                        ...
                        <div class="tab-pane fade show active" id="nav-pinfo" role="tabpanel" aria-labelledby="nav-pinfo-tab">
                            <div class="row">
                                <div class="col-sm-6 pinfo">
                                    ...
                                    <p><span>Name:</span> {{ $booking->certificationBundle->name }}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 pinfo">
                                    ...
                                    <p><span>Date Confirmed:</span> {{ $booking->payment->date_approved ? date('F j Y', strtotime($booking->payment->date_approved)) : 'Not Set' }}</p>
                                </div>
                            </div>
                        </div>                            
                    </div>
