...
@section('title', 'Registered Certification Bundles')
    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <!-- current page -->
                <span class="bc-current-page">Registered Certification Bundles</span>
            </div>
                                        ...
                                        @forelse ($bookings as $booking)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="td-ma-btn" href="{{ route('customer.account.certification_bundle.show', $booking) }}">
                                                        View Details
                                                    </a>
                                                </td>
                                            </tr>
