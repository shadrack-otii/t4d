...
@section('title', "{$booking->courseBundle->name} | Registered Courses")
                        ...
                        <div class="tab-pane fade show active" id="nav-course-bundle" role="tabpanel" aria-labelledby="nav-course-bundle-tab">
                            <div class="row">
                                <div class="col-sm-6 pinfo">
                                    ...
                                    <p><span>Name:</span> {{ $booking->courseBundle->name }}</p>
                                    <p><span>Fees:</span> {{ $booking->currency }} {{ number_format($booking->schedule_cost) }}</p>
                                </div>
