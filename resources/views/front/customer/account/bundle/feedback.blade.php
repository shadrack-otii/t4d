...
@section('title', "{$booking->courseBundle->name} | Registered Certifications")
                        ...
                        <div class="tab-pane fade show active" id="nav-course-bundle" role="tabpanel" aria-labelledby="nav-course-bundle-tab">
                            <div class="row">
                                <div class="col-sm-6 pinfo">
                                    <form action="{{ route('customer.account.certification.issue', $booking) }}" method="POST">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select class="form-control" name="trainers[]" multiple>
                                                        @foreach ($booking->courseBundle->trainers as $trainer)
                                ...
                                <div class="col-sm-6 pinfo">
                                    <form action="{{ route('customer.account.certification.review', $booking) }}" method="POST">
