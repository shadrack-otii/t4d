...
@section('title', "{$booking->certification->name} | Registered Courses")
    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <span>
                    <a href="{{ route('customer.account.certification.index') }}">
                        ...
                        <div class="tab-pane fade show active" id="nav-pinfo" role="tabpanel" aria-labelledby="nav-pinfo-tab">
                            <div class="row">
                                <div class="col-sm-6 pinfo">
                                    ...
                                    <p><span>Name:</span> {{ $booking->certification->name }}</p>
