    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <span>
                    <a href="{{ route('certification.bundle.show', $booking->certificationBundle) }}">
            ...
            <div class="ip-content row">
                <div class="col-sm-6 offset-sm-3">
                    <p>
                        Thank you for registering for <b>{{ $booking->certificationBundle->name }}</b>.
                    </p>
    
                    <h5>Certification Bundle</h5>
    
                    <table class="table table-bordered">
                        <tr>
                            <td>Course</td>
                            <td>{{ $booking->certificationBundle->name }}</td>
                        </tr>
                        <tr>
                            <td>Schedule</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                @switch($booking->schedule_type)
                                    ...
                                    @case('App\PhysicalCertificationBundle')
                                        Face to Face
                                        @break
    
                                    @case('App\VirtualCertificationBundle')
                                        Virtual
                                        @break
