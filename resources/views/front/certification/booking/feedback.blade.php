    ...
    <div class="main-body">
        ...
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <span>
                    <a href="{{ route('certification.show', $booking->certification) }}">
            ...
            <div class="ip-content row">
                <div class="col-sm-6 offset-sm-3">
                    <p>
                        Thank you for registering for <b>{{ $booking->certification->name }}</b>.
                    </p>
                        ...
                        <tr>
                            ...
                            <td>
                                @switch($booking->schedule_type)
                                    ...
                                    @case('App\PhysicalCertification')
                                        Face to Face
                                        @break
    
                                    @case('App\VirtualCertification')
                                        Virtual
                                        @break
