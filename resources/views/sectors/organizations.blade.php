    ...
    <section class="bg-cover bg-center h-96 relative" style="background-image: url('/images/forestblog.png');">
        ...
        <div class="absolute inset-0 flex items-center justify-center text-center text-white">
            <div class="max-w-3xl px-4">
                <h1 class="text-4xl font-bold mb-4">Mobile Data Collection in       Humanitarian and INGOs,NGOs,CBO,Church Based Organizations,Foundations,International corporations,embassies,regional bodies,Donor Agencies
                </h1>
                {{-- <p class="text-lg">By
                    Lee
                    February 6, 2025</p> --}}
