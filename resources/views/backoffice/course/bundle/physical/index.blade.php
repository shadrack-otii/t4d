                        ...
                        <div class="body">
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="dt-buttons">
                                    <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.course.bundle.physical.create', $bundle) }}">
                                        ...
                                        <tbody>
                                            @forelse ($schedules as $schedule)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('backoffice.course.bundle.physical.edit', [

                                                            'bundle' => $bundle,
                                                            'physical_bundle' => $schedule,
                                                            
                                                        ]) }}" class="btn btn-sm btn-secondary">Edit</a>

                                                        &nbsp;

                                                        <form class="form-action" action="{{ route('backoffice.course.bundle.physical.destroy', [
