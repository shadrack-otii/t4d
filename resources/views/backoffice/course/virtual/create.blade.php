...
@section('title', "Add Virtual Schedule | $course->name")
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{ route('backoffice.course.virtual_class.store', $course) }}" method="post" id="schedule-form">
                                        ...
                                        <div class="input-daterange input-group" id="bs_datepicker_range_container">
                                            ...
                                            <div class="form-line">
                                                <input type="date" class="form-control" placeholder="Date end..." name="to" value="{{ old('to') }}" min="{{ date('Y-m-d') }}" min="{{ date('Y-m-d') }}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <input type="number" name="tax" class="form-control" placeholder="Tax Percentage" value="{{ @App\VirtualVenue::first()->tax ?? 0 }}">
                                            </div>
