...
@section('title', "Virtual Schedule | $course->name")
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header clearfix">
                            <h2 class="pull-left">
                                {{ strtoupper($course->name) }} VIRTUAL SCHEDULE
                            </h2>
                        ...
                        <div class="body">
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="dt-buttons">
                                    <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.course.virtual_class.create', $course) }}">
                                        ...
                                        <tbody>
                                            @forelse ($classes as $schedule)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('backoffice.course.virtual_class.edit', [

                                                            'course' => $course,
                                                            'virtual_class' => $schedule,
                                                            
                                                        ]) }}" class="btn btn-sm btn-secondary">Edit</a>

                                                        &nbsp;

                                                        <form class="form-action" action="{{ route('backoffice.course.virtual_class.destroy', [
