...
@section('title', 'Add ' . ucfirst($category->name) . ' Subcategory')
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header clearfix">
                            <h2 class="pull-left">
                                ADD NEW {{ strtoupper($category->name) }} SUBCATEGORY
                            </h2>
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('backoffice.course.category.subcategory.store', $category) }}" method="POST" enctype="multipart/form-data">
