...
@section('title', "Edit Face to Face Schedule | $certification->name")
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{ route('backoffice.certification.physical.update', compact('certification', 'physical')) }}" method="post" id="schedule-form">
