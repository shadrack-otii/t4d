                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{ route('backoffice.certification.store') }}" method="post" id="certification-form" enctype="multipart/form-data">
                                        ...
                                        <div v-if="categories.length && subcategories.length">
                                            ...
                                            <div class="">
                                                <textarea name="prerequisite" class="ckeditor">{{ old('prerequisite') }}</textarea>
                                            </div>
