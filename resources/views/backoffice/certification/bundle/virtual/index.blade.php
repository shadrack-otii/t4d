                        ...
                        <div class="body">
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="dt-buttons">
                                    <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.certification_bundle.virtual.create', $bundle) }}">
                                        ...
                                        <tbody>
                                            @forelse ($classes as $schedule)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('backoffice.certification_bundle.virtual.edit', [
                                                        ...
                                                        <form class="form-action" action="{{ route('backoffice.certification_bundle.virtual.destroy', [
