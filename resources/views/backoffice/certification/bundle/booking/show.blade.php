                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header clearfix">
                            <h2 class="pull-left">
                                {{ strtoupper($booking->certificationBundle->name) }} BOOKING DETAILS
                            </h2>
                            <a class="pull-right" href="{{ route('backoffice.certification_bundle.booking.index') }}">
                                Back to bookings
                            </a>
                        </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form method="POST" action="{{ route('backoffice.certification_bundle.booking.update', $booking) }}">
