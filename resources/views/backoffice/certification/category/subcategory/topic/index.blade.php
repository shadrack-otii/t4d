            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('backoffice.certification.subcategory.topic.store', $subcategory) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            ...
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="dt-buttons">
                                    <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.certification.topic.export', $subcategory) }}" target="_blank">
                                        ...
                                        <tbody>
                                            @forelse ($topics as $topic)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('backoffice.certification.subcategory.topic.edit', compact('subcategory', 'topic')) }}" class="btn btn-sm btn-success">Edit</a> 
                                                        &nbsp;

                                                        @can('delete_certifications')
                                                        <form class="form-action" action="{{ route('backoffice.certification.subcategory.topic.destroy', compact('subcategory', 'topic')) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
