            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('backoffice.venue.update', $venue) }}" method="POST">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="country" id="country" class="form-control" placeholder="Country Name" value="{{ old('country', $venue->country) }}">
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="reg_no" id="reg_no" class="form-control" placeholder="Company Registration Number" value="{{ old('reg_no', $venue->reg_no) }}">
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tax_pin" id="tax_pin" class="form-control" placeholder="Company Pin" value="{{ old('tax_pin', $venue->tax_pin) }}">
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tax" id="tax" class="form-control" placeholder="tax Number" value="{{ old('tax', $venue->tax ?? 0) }}">
                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7 col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <div class="form-group">
                                            <input type="checkbox" id="head_office" name="head_office" class="filled-in chk-col-red"
                                            @if ( old('head_office', $venue->head_office) )
                                                checked
                                            @endif>
