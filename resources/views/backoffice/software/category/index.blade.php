...
@section('title', 'Categories | Enterprise Systems')
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('backoffice.software.category.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            ...
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="dt-buttons">
                                    {{-- <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.software.category.create') }}">
                                        <span>Add Category</span>
                                    </a> --}}
                                    @can('export_data')
                                    <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.software.category.export') }}" target="_blank">
                                        ...
                                        <tbody>
                                            @forelse ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('backoffice.software.category.subcategory.index', $category) }}" class="btn btn-sm btn-secondary">
                                                            View Subcategories
                                                        </a> 
                                                        &nbsp;
                                                        <a href="{{ route('backoffice.software.category.edit', $category) }}" class="btn btn-sm btn-success">Edit</a> 
                                                        &nbsp;
                                                        <form class="form-action" action="{{ route('backoffice.software.category.destroy', $category) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
