...
@section('title', "Add Subcategory | {$category->name} | Enterprise Systems")
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header clearfix">
                            ...
                            <a class="pull-right" href="{{ route('backoffice.software.category.subcategory.index', $category) }}">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('backoffice.software.category.subcategory.store', $category) }}" method="POST" enctype="multipart/form-data">
