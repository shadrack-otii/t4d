...
@section('title', 'Edit Service Capability')
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{route('backoffice.capabilities.update', $capability)}}" method="post" id="course-form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="name" class="form-control" placeholder="Name" value="{{ $capability->name }}">
                                            </div>
                                        ...
                                        <div class="">
                                            ...
                                            <textarea name="description" class="ckeditor">{{ $capability->description }}</textarea>
                                        </div>
                                        <!-- End -->
