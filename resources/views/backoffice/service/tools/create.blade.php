...
@section('title', 'Add Tools Uses | '. $service->name)
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header clearfix">
                        <h2 class="pull-left">
                            Add Tools Used in {{$service->name}}
                        </h2>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <form action="{{ route('backoffice.service.add.tool', $service->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" name="tool_name" class="form-control" placeholder="Tool Name" value="{{old('tool_name')}}">
                                                </div>
