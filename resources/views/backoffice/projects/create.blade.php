                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{route('backoffice.projects.store')}}" method="post" id="course-form" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="date" name="start_date" class="form-control" value="2023-01-01">
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="date" name="end_date" class="form-control" value="2023-01-01">
                                                        </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-line">
                                                            <select class="form-control" name="status" required>
                                                                <option selected value="In Progress">Not Started</option>
                                                                <option selected value="In Progress">Completed</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="number" name="cost_estimate" class="form-control" placeholder="0.00" value="{{ old('cost_estimate') }}" required>
                                                        </div>
