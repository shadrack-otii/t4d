                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{route('backoffice.career-modules.store')}}" method="post" id="course-form" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="text" name="title" class="form-control" placeholder="Job Title" value="{{ old('title') }}" id="Title">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <textarea name="Job_description" class="ckeditor" id="Job_description">{!! old('Job_description') ?? 'Give a small description
                                                        about the job ...' !!}</textarea>                                                   
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        <textarea name="requirements" class="ckeditor" id="requirements">{{ old('requirements') ?? 'List 
                                                        the requirements here ...' }}</textarea>                                                    
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <div class="form-line">
                                                            ...
                                                            <input type="date" class="form-control" placeholder="Date start..." name="date" value="{{ old('date') ?? null }}" min="{{ date('Y-m-d') }}">
                                                        </div>           
                                                    </div>
                                                </div>
                                            </div>
