            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="{{ route('backoffice.tour.category.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            ...
                            <div class="dataTables_wrapper form-inline dt-bootstrap">
                                ...
                                <div class="dt-buttons">
                                    <a class="dt-button buttons-html5" tabindex="0" href="{{ route('backoffice.tour.category.export') }}" target="_blank">
                                        ...
                                        <tbody>
                                            @forelse ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('backoffice.tour.category.subcategory.index', $category) }}" class="btn btn-sm btn-secondary">
                                                            View Subcategories
                                                        </a> 
                                                        &nbsp;
                                                        <a href="{{ route('backoffice.tour.category.edit', $category) }}" class="btn btn-sm btn-success">Edit</a> 
                                                        &nbsp;
                                                        @can('delete_tours')
                                                        <form class="form-action" action="{{ route('backoffice.tour.category.destroy', $category) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
