                                ...
                                <div class="col-sm-12">
                                    <form action="{{ route('backoffice.programs.programs.update', $program->id) }}"
                                        ...
                                        <div class="">
                                          ...
                                          <div class="">
                                              <textarea name="objective" class="ckeditor">{{ $program->objective }}</textarea>
                                          </div>
                                        ...
                                        <h4>Change Tech stacks Associated</h4>
                                                ...
                                                <select id="Tech_stacks" name="TechStack[]"
                                                    ...
                                                    @foreach (App\TechStack::all() as $tech)
                                                        <option value="{{ $tech->id }}"
                                                            @if (in_array($tech->id, old('TechStack', @$program->techstacks->modelKeys() ?? []))) selected @endif>
                                                            {{ $tech->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
