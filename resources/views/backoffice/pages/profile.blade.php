                            ...
                            <form class="form-horizontal" action="" method="POST">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="password" id="password" type="text" class="form-control" placeholder="New Password" value="{{ old('password') }}">
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="password_confirmation" id="password_confirmation" type="text" class="form-control" placeholder="Enter password again" value="{{ old('password_confirmation') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
