                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form action="{{route('backoffice.faqs.update', $faq)}}" method="post" id="course-form" enctype="multipart/form-data">
                                        ...
                                        <div v-if="categories.length && subcategories.length">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" name="title" class="form-control" placeholder="Title or Question?" value="{{$faq->title}}">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <textarea name="description" class="ckeditor">{{$faq->description}}</textarea>
                                            </div>
                                            <!-- End -->
