...
use App\Http\Controllers\Backoffice\Tour\Export\SubcategoryExcelExport;
use Storage;
use Str;
...
class SubcategoryController extends Controller
{
    ...
    public function index(Request $request, Category $category)
    {
        ...
        return view('backoffice/tour/category/subcategory/index', compact('subcategories', 'category'));
    }
    ...
    {
        return view('backoffice/tour/category/subcategory/create', compact('category'));
    }
    ...
    {
        $cover = $request->hasFile('cover') ? $request->file('cover')->store('tour/category/subcategory') : null;
    ...
    {
        return view('backoffice/tour/category/subcategory/edit', compact('category', 'subcategory'));
    }
    ...
    public function update(UpdateRequest $request, Category $category, Subcategory $subcategory)
    {
        if ( $request->hasFile('cover') ) {
            ...
            $cover = $request->file('cover')->store('tour/category/subcategory');
    ...
    {
        return ( new SubcategoryExcelExport($category) )->download("$category->name tour subcategories.xlsx");
    }
}
