...
use App\Http\Controllers\Backoffice\Tour\Export\CategoryExcelExport;
use Str;
...
class CategoryController extends Controller
{
    ...
    {
        $categories = Category::tour()->when($request->search, function ($query, $search) {
        ...
        return view('backoffice/tour/category/index', compact('categories'));
    }
    ...
    {
        return view('backoffice/tour/category/create');
    }
    ...
    {
        $cover = $request->hasFile('cover') ? $request->file('cover')->store('tour/category') : null;
    ...
    {
        return view('backoffice/tour/category/edit', compact('category'));
    }
    ...
    public function update(UpdateRequest $request, Category $category)
    {
        if ( $request->hasFile('cover') ) {
            ...
            $cover = $request->file('cover')->store('tour/category');
    ...
    {
        return ( new CategoryExcelExport )->download('tour categories.xlsx');
    }
}
