...
class CertificationBooking extends Model
{
     ...
     */
    protected $fillable = [
        'schedule_id', 'schedule_type', 'schedule_cost', 'salutation', 'name', 'designation', 'company_id', 'country', 'phone', 'personal_email', 'work_email', 'currency_code', 'learn_about_us', 'payment_method', 'approved_authority_id', 'certification_id', 'tax_percentage',
    ];
    ...
    {
        return $this->hasMany(CertificationBookingParticipant::class, 'certification_booking_id');
    }
